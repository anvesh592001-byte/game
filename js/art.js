...
const CHARS = {
  aditya: {
    ...
    speed: 3.4, jump: 12.5, hp: 110, dmg: 12, atkRange: 62, ranged: false,
  ...
  arjun: {
    ...
    speed: 4.3, jump: 13.5, hp: 90, dmg: 9, atkRange: 56, ranged: false, doubleJump: true,
  ...
  ravi: {
    ...
    speed: 3.2, jump: 12.0, hp: 85, dmg: 10, atkRange: 340, ranged: true,
  ...
  kiran: {
    ...
    speed: 2.7, jump: 11.0, hp: 145, dmg: 16, atkRange: 70, ranged: false,
